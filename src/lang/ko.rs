...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("server_requires_deployment_tip", "서버에서 이 장치를 명시적으로 배포해야 합니다. 지금 배포하시겠습니까?"),
        ...
        ("wayland-keyboard-input-reset-choice-tip", "키보드 입력 선택 사항 재설정"),
        ("remember-wayland-keyboard-choice-tip", "이 원격 컴퓨터에 대해서는 다시 묻지 않음"),
        ("Why this happens", "이 현상이 발생하는 이유"),
        ("Switch display", "디스플레이 전환"),
        ("Show monitor switch button on the main toolbar", "기본 도구 모음에 모니터 젆한 버튼 표시"),
